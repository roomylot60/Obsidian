...
- 이러한 번역 방식과 기존의 샘플 번역들의 정확도를 측정하였고, 문장 표현의 결과를 시각화 하였다.

#### 3.1 Dataset details

- 우리는 WMT’14 영어에서 프랑스어 데이터 셋을 사용했습니다. 
- 348M 프랑스어 단어와 304M 영어 단어로 구성된 12M 문장의 하위 집합으로 모델을 훈련시켰습니다. 이는의 깨끗한 "선택된" 하위 집합입니다. 이 번역 작업과 특정 훈련 세트 하위 집합을 선택한 이유는 기본 SMT의 토큰화된 훈련 및 테스트 세트와 1000-최고 리스트가 공개적으로 사용 가능하기 때문입니다.
